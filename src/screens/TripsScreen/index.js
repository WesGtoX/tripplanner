...
class TripsScreen extends Component {
    ...
    renderItem = item => {
        return <Trip onPress={() => {
            this.props.navigation.navigate('Trip', { id: item.item.id, reflesh: this.loadData })
        ...
        return(
            <View style={{
                ...
                <View style={{
                    ...
                    />
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('AddTrip', {reflesh: this.loadData })} style={{
                        position: 'absolute',
                        bottom: 0,
                        right: 20,
                        padding: 10
